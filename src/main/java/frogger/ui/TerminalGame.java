...
public class TerminalGame {
    ...
    private void drawFrog() {
        ...
        drawPosition(frog.getBody(), TextColor.ANSI.GREEN, '\u2588', true);

    }

    private void drawObstacles() {
        for (Position obstacle : game.getObstacle()) {
            drawPosition(obstacle, TextColor.ANSI.RED, '\u23FE', false);
        }
    }
